...
class Navigation {
   ...
   */
  getDNSTime(domainLookupStart: number, domainLookupEnd: number): number {
   ...
   */
  getTCPTime(connectStart: number, connectEnd: number): number {
   ...
   */
  getDownloadTime(responseStart: number, responseEnd: number): number {
   ...
   * @returns {Number} 缓存耗时
   */
  getAppCacheTime(fetchStart: number, domainLookupStart: number): number {
   ...
   */
  getFetchResourceTime(fetchStart: number, responseEnd: number): number {
   ...
   */
  getAfterDOMReadyTheDownloadTimeOfTheRes(domInteractive: number, domComplete: number): number {
   ...
   * @returns {Number} 白屏时间
   */
  getWhiteScreenTime(fetchStart: number, domInteractive: number): number {
   ...
   */
  getDOMReadyTime(fetchStart: number, domContentLoadedEventEnd: number): number {
   ...
   */
  getLoadTime(domContentLoadedEventStart: number, domContentLoadedEventEnd: number): number {
   ...
   */
  getTTFB(requestStart: number, responseStart: number): number {
